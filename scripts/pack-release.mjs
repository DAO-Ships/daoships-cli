...
export const RELEASE_ARCHIVE = 'daoships-cli.tgz';
...
export async function saveReleaseArchive(source, packed, expectedVersion, {
  ...
  assert.equal(packed.name, '@daoships/cli');
...
// Uses Node builtins only: the privileged publisher never imports CLI dependencies.
